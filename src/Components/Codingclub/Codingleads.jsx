...
import lead1 from '../assets/Untitled design (1).png'; // Example image paths
import lead2 from '../assets/Untitled design (2).png'; // Example image paths
